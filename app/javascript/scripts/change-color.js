...
const setColor1 = (body) => {
  body.classList.add("color-1");
}
const removeColor1 = (body) => {
  body.classList.remove("color-1");
}
const setColor2 = (body) => {
  body.classList.add("color-2");
}
const removeColor2 = (body) => {
...
const changeColor = () => {
  ...
  // btn_triad.addEventListener("mouseover", () => setColor1(body));
  // btn_triad.addEventListener("mouseleave", () => removeColor1(body));
  // btn_tritone.addEventListener("mouseover", () => setColor2(body));
  // btn_tritone.addEventListener("mouseleave", () => removeColor2(body));
